...
internal object LoggerNameResolver {
    ...
    internal fun getLoggerNameForKClassesWithQualifiedName(forClass: KClass<*>): String {
    ...
    internal fun removeCompanionAndInnerClassSeparatorFromName(loggerName: String): String {
