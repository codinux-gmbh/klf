...
class NotifyAboutLogEventsAppenderTest {
    ...
    fun append_InfoWithoutThreadName() {
        ...
        assertThat(receivedEvents.first().loggerName).isEqualTo(LoggerFactory.defaultLoggerName)
    ...
    fun append_WarnWithoutException() {
        ...
        Log.warn(Exception("Just a test")) { "Warn" }
    ...
    fun append_ErrorWithException() {
        ...
        Log.error(Exception("Just a test")) { "Error" }
        ...
        assertThat(receivedEvents.first().exception!!.message).isEqualTo("Just a test")
    }
